...
@section('title', 'Eliminar Usuario - ' . $user->username . ' | Novelas _try')

@section('typeAdmin', 'Eliminar Usuario - ' . $user->username)
...
@section('content')
    ...
    <div class="alert alert-danger" role="alert">
        ¿Estas seguro que quieres <strong>Eliminar</strong> esta cuenta?
    </div>
